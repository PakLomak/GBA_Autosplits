...
split
{
    ...
    if (settings["C_IQ"] && current.room == 0x10 && old.Area == 0x00 && current.Area == 0x04) return true; //Castle Corridor -> Inner Quarters
    if (settings["IQ_C"] && old.room == 0x22 && current.room == 0x21 && current.Area == 0x00) return true; //Inner Quarters -> Castle Corridor
    ...
    if (settings["C_ChZ"] && old.room == 0x27 && current.room == 0x08 && current.Area == 0x01) return true; //Castle Corridor -> Chapel ZIP
    if (settings["IQP"] && old.room == 0x0D && current.room == 0x15 && current.Area == 0x04) return true; //Inner Quarters Portal
...
startup
{
	...
	settings.Add("JULIUS_All_Bosses", true, "JULIUS All Bosses");
	settings.Add("C_U", true, "Castle Corridor -> Underground Reservoir", "JULIUS_All_Bosses");
	settings.Add("U_FA", true, "Underground Reservoir -> Forbidden Area", "JULIUS_All_Bosses");
	settings.Add("FA_S", false, "Forbidden Area -> Study", "JULIUS_All_Bosses");
    settings.Add("S_Ch", true, "Study -> Chapel", "JULIUS_All_Bosses");
    settings.Add("C_DH", true, "Castle Corridor -> Dance Hall", "JULIUS_All_Bosses");
    settings.Add("DH_IQ", false, "Dance Hall -> Inner Quarters", "JULIUS_All_Bosses");
    settings.Add("U_A", true, "Underground Reservoir -> The Arena", "JULIUS_All_Bosses");
    settings.Add("TF_CT", true, "Top Floor -> Clock Tower", "JULIUS_All_Bosses");
    settings.Add("CT_TF", false, "Clock Tower -> Top Floor", "JULIUS_All_Bosses");
    settings.Add("JULIUS", true, "JULIUS Any%");
    settings.Add("C_ChZ", true, "ZIP Castle Corridor -> Chapel", "JULIUS");
    settings.Add("C_IQ", false, "Castle Corridor -> Inner Quarters", "JULIUS");
    settings.Add("IQ_C", false, "Inner Quarters -> Castle Corridor", "JULIUS");
    settings.Add("IQP", false, "Inner Quarters Portal", "JULIUS");
    settings.Add("One_way", true, "One way");
    settings.Add("IQ_TF", true, "Inner Quarters -> Top Floor", "One_way");
    settings.Add("Room_Garaham", true, "Room Garaham", "One_way");
}